...
const Feedback = ({ measure, handleCloseClick, handleCloseMenuItem }) => {
  ...
  return (
    <div className="bg-white z-30">
      <p className="w-full text-center font-Georgia font-bold text-4xl sm:mt-8 sm:mb-4">
        Thank You!
      </p>
      ...
      <p className="mx-8 mt-2 lg:mb-10 text-sm lg:text-base text-center font-Roboto text-xs leading-relaxed tracking-widest">
        Thank you for providing your feedback, did you know we have a secret affiliate
        program for those who are wanting to help support us.<br/><br/>
        Permanently receive 1% discount for every 5 new customers
        you bring to our app who make a purchase of at least 1 item.<br/><br/>
        Receive a maximum discount of 10% for all your future purchases.
      </p>
      <div className="md:fixed bottom-3vh w-full z-0">
