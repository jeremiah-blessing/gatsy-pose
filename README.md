...
1.  **Clone this repository**
    ...
    ```shell
    git clone https://github.com/mehnomy/esatta-app.git
    cd esatta-app
    ```

2.  **Install Gatsby CLI on Mac OSX**

    Ensure Gatsby CLI is installed prior to installing the dependencies, you will require node and xcode installed. 
...
3.  **Install Esatta dependencies**
    ```shell
    npm install
    #audit fix if required
    ```
